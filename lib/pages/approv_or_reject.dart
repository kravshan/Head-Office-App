...
class Approv_or_reject extends StatefulWidget {

  @override
  _Approv_or_rejectState createState() => _Approv_or_rejectState();
}

class _Approv_or_rejectState extends State<Approv_or_reject> {
  @override
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox( height: 50.h, width: 150.w,
                      child: FlatButton(
                        onPressed: (){Navigator.popAndPushNamed(context, '/confirmed_case');},
