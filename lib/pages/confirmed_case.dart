...
class Confirmed_Case extends StatefulWidget {

  @override
  _Confirmed_CaseState createState() => _Confirmed_CaseState();
}

class _Confirmed_CaseState extends State<Confirmed_Case> {
  @override
            ...
            children: [
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Confirmed Case XXXXX details', style: TextStyle(fontSize: 18.sp, fontFamily: 'Comfortaa', fontWeight: FontWeight.w400),),
                    SizedBox(height: 200.h,),
                    SizedBox( height: 50.h, width: 150.w,
                      child: FlatButton(
                        onPressed: (){Navigator.pop(context);},
                        child: Text('Approve', style: TextStyle(fontWeight: FontWeight.w700, fontFamily: 'Poppins', fontSize: 14.sp, color: Colors.white),),
              ...
              Column(
                children: [
                  ...
                  SizedBox( height: 50.h, width: 150.w,
                    child: FlatButton(
                      onPressed: (){Navigator.popAndPushNamed(context, '/rejected');},
                      child: Text('Reject', style: TextStyle(fontWeight: FontWeight.w700, fontFamily: 'Poppins', fontSize: 14.sp, color: Colors.white),),
